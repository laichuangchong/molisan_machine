...
/***/ "./node_modules/css-loader/index.js!./src/static/css/machine_add.css":
/***/ (function(module, exports, __webpack_require__) {
...
var _reactAddonsUpdate = __webpack_require__("./node_modules/react-addons-update/index.js");
...
__webpack_require__("./src/static/css/machine_add.css");

var _common = __webpack_require__("./src/static/js/common.js");
...
var searchText = ''; //搜索内容
var skip = _common.initskip; //从第几位开始加载
var locations = []; //省市数据

var resetGoodsFn = function resetGoodsFn(Level, Channel, obj) {
    //定义重置货架函数
    var testobj = [];
    var vendId = obj.props.params.id;
    ...
    console.log(testobj);
    $.ajax({
        url: _common.xhrurl + '/odata/MachineCapacities?$filter=VendingMachineId eq ' + vendId,
        type: 'POST',
        data: testobj,
...
var MachineAddUi = function (_React$Component) {
    _inherits(MachineAddUi, _React$Component);

    function MachineAddUi(props) {
        _classCallCheck(this, MachineAddUi);

        var _this2 = _possibleConstructorReturn(this, (MachineAddUi.__proto__ || Object.getPrototypeOf(MachineAddUi)).call(this, props));

        _this2.chooseProvince = function () {
            //省市选择
            var _this = _this2;
            // 级联picker
            _weui2.default.picker(_this2.props.locations.locations, {
                ...
                onConfirm: function onConfirm(result) {
                    ...
                    _this.setState({
                        ...
                        City: result[1].label,
                        results: (0, _reactAddonsUpdate2.default)(_this.state.results, {
        ...
        _this2.state = {
            ...
            relativeData: { //关联公众号及素材列表
                ...
                { GongzhonghaoId: 7, Name: "硅谷创业者联盟", WeChatId: "svace-org" }, { GongzhonghaoId: 5, Name: "魔力伞", WeChatId: "魔力伞", Description: "魔力伞公众号，提供天气解决方案" }]
            },
            Gongzhonghaos: [//搜索结果公众号

            { GongzhonghaoId: 5, Name: "魔力伞", WeChatId: "魔力伞", Description: "魔力伞公众号，提供天气解决方案" }, { GongzhonghaoId: 7, Name: "硅谷创业者联盟", WeChatId: "svace-org" }, { GongzhonghaoId: 8, Name: "硅谷天使会SVCAngel", WeChatId: "SVCAngel" }],
            Province: '',
            City: '',
            mask: false,
            showGoods: false,
    ...
    _createClass(MachineAddUi, [{
        ...
        key: 'addItem',
        value: function addItem(name, id, type) {
            //添加绑定公众号
            var _this = this;
            switch (type) {
                case 'subscription':
                    for (var i = 0; i < _this.state.relativeData.Gongzhonghaos.length; i++) {
                        if (id == _this.state.relativeData.Gongzhonghaos[i].GongzhonghaoId) {
                            _weui2.default.alert('此公众号已绑定');
                            return;
                        }
                    }

                    _weui2.default.confirm('确定添加' + name + '吗？', {
                        buttons: [{
                            label: '取消',
                            type: 'default',
                            onClick: function onClick() {
                            ...
                            onClick: function onClick() {
                                _this.setState({
                                    relativeData: (0, _reactAddonsUpdate2.default)(_this.state.relativeData, {
        ...
        key: 'removeItem',
        value: function removeItem(name, id, type) {
            //删除关联公众号
            var _this = this;
            _weui2.default.confirm('确定删除' + name + '吗？', {
                buttons: [{
                    label: '取消',
                    type: 'default',
                    onClick: function onClick() {
                            ...
                            case 'material':
                                _this.setState({
                                    relativeData: (0, _reactAddonsUpdate2.default)(_this.state.relativeData, {
                                        materials: {
                                            $apply: function $apply() {
                                                for (var i = 0; i < _this.state.relativeData.materials.length; i++) {
        ...
        key: 'showGoodsItem',
        value: function showGoodsItem(ChannelCapacity, RemainCount, name, Level, Channel, ItemId, MachineCapacityId) {
            this.setState({
                mask: true,
                goodItem: true,
                editGoodItemData: {
        ...
        key: 'handleChange',
        value: function handleChange(arg1, arg2, arg3) {
            //监听输入变化
            var _this = this;
            console.log(arg3);
            switch (arguments.length) {
                case 2:
                    _this.setState(_defineProperty({}, arg1, arg2.target.value));
                    break;
                case 3:
                    _this.setState(_defineProperty({}, arg1, (0, _reactAddonsUpdate2.default)(_this.state[arg1], _defineProperty({}, arg2, { $set: arg3.target.value }))));
                    break;
            }
        ...
        value: function returnList() {
            //返回按钮
            _reactRouter.hashHistory.push('/home/machine');
        }
    }, {
        key: 'handleSubmit',
        value: function handleSubmit() {
            //提交表单
            var formData = this.state.results;
            var _this = this;
            var validMark = true;
            if (this.props.params.id) {
                if ((0, _common.validForm)(_this, formData, validMark)) {
                    //编辑页面
                    _weui2.default.confirm('确认提交?', {
                        buttons: [{
                            label: '取消',
                            type: 'default'
                        }, {
                ...
                if ((0, _common.validForm)(_this, formData, validMark)) {
                    ...
                    _weui2.default.confirm('添加成功', {
                        buttons: [{
                            ...
                            type: 'primary',
                            onClick: function onClick() {
                                _reactRouter.hashHistory.push('/machine/edit/5');
                                location.reload();
                            }
                        }]
                    });
        ...
        key: 'editGoodItem',
        value: function editGoodItem() {
            //修改商品弹出框确定修改
            var _this = this;
            console.log(this.state.editGoodItemData);
            var _state$editGoodItemDa = this.state.editGoodItemData,
                ChannelCapacity = _state$editGoodItemDa.ChannelCapacity,
                RemainCount = _state$editGoodItemDa.RemainCount,
                name = _state$editGoodItemDa.name,
                Level = _state$editGoodItemDa.Level,
                Channel = _state$editGoodItemDa.Channel,
                ItemId = _state$editGoodItemDa.ItemId,
                MachineCapacityId = _state$editGoodItemDa.MachineCapacityId;
            ...
            $.ajax({
                url: _common.xhrurl + '/odata/MachineCapacities(' + MachineCapacityId + ')',
                type: 'POST',
        ...
        key: 'handleSearch',
        value: function handleSearch(text, e) {
            //搜索结果数据
            e.preventDefault();
            var url = '';
            skip = 0;
            searchText = text;
            if ($.trim(searchText) == '') {
                //判断搜索内容是否为空，如果为空就显示全部数据
                url = _common.xhrurl + '/odata/Gongzhonghaos?&$skip=' + skip + '&$top=' + _common.inittop;
            } else {
                url = _common.xhrurl + '/odata/Gongzhonghaos?$filter=Name eq \'' + searchText + '\'&$skip=' + skip + '&$top=' + _common.inittop;
            }
            (0, _common.XHR)(this, url, 'Gongzhonghaos');
        }
    }, {
        key: 'resetGoods',
        value: function resetGoods(Level, Channel) {
            //重制设备货架
            var _this = this;

            _weui2.default.confirm('确定后所有商品数据将清空，务必确认排数和列数填写正确', {
                buttons: [{
                    label: '取消',
                    type: 'default',
                    onClick: function onClick() {
        ...
        key: 'setLevelChannel',
        value: function setLevelChannel() {
            //重制设备货架
            var _this = this;
        ...
        value: function componentWillReceiveProps(nextProps) {
            var _this = this;
            if (nextProps.locations.locations.length != 0) {
                //获取省市列表
            ...
            if (this.props.params.id) {
                ...
                $.ajax({
                    ...
                    complete: function complete(response) {
                        ...
                        var items = response.responseJSON.value; //获取商品名称、价格、图片
                        var goods = [];
                        ...
                        $.ajax({
                            ...
                            complete: function complete(response) {
                                console.log(response.responseJSON.value);
                                var data = response.responseJSON.value;
                                for (var _i = 0; _i < data.length; _i++) {
                                    for (var j = 0; j < items.length; j++) {
                                        if (data[_i].ItemId == items[j].ItemId) {
                                            data[_i].Name = items[j].Name;
                                        }
                                    }
                                }
                                console.log(data);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _packages.CellBody,
                            null,
                            _react2.default.createElement(_packages.Input, { type: 'text', placeholder: '', name: 'Name', onChange: this.handleChange.bind(this, 'results', 'Name'), value: this.state.results.Name })
                        )
                    ),
                    _react2.default.createElement(
                        _packages.FormCell,
                        ...
                        _react2.default.createElement(
                            _packages.CellBody,
                            null,
                            _react2.default.createElement(_packages.Input, { type: 'text', onClick: this.chooseProvince, value: this.state.Province + ' ' + this.state.City })
                        )
                    ),
                    _react2.default.createElement(
                        _packages.FormCell,
                        ...
                        _react2.default.createElement(
                            _packages.CellBody,
                            null,
                            _react2.default.createElement(_packages.Input, { type: 'text', placeholder: '', name: 'Address', onChange: this.handleChange.bind(this, 'results', 'Address'), value: this.state.results.Address })
                        )
                    )
                ),
                this.props.params.id ? _react2.default.createElement(
                    ...
                    this.state.showLeveLChannel ? _react2.default.createElement(
                        _packages.Form,
                        null,
                        _react2.default.createElement(
                            _packages.FormCell,
                            ...
                            _react2.default.createElement(
                                _packages.CellBody,
                                null,
                                _react2.default.createElement(_packages.Input, { type: 'number', placeholder: '', name: 'name', max: '20', value: this.state.Level,
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _packages.CellBody,
                                null,
                                _react2.default.createElement(_packages.Input, { type: 'number', placeholder: '', name: 'name', max: '20', value: this.state.Channel,
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    _packages.Grids,
                                    null,
                                    this.state.MachineCapacities.map(function (item, index) {
                                        return _react2.default.createElement(
                                            'div',
                                            { className: 'weui-grid', onClick: _this3.showGoodsItem.bind(_this3, item.ChannelCapacity, item.RemainCount, item.Name, item.Level, item.Channel, item.ItemId, item.MachineCapacityId), key: index },
                                            _react2.default.createElement(
                                                'span',
                                                null,
                                                '\u6392\uFF1A',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _packages.FormCell,
                        { warn: !this.state.form.Description.valid },
                        _react2.default.createElement(
                            _packages.CellBody,
                            null,
                            _react2.default.createElement(_packages.TextArea, { placeholder: '\u4E0D\u8D85\u8FC7200\u5B57', rows: '3', maxlength: '200', value: this.state.results.Description, onChange: this.handleChange.bind(this, 'results', 'Description') })
                        )
                    )
                ),
                this.props.params.id ? _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _packages.Button,
                            { size: 'small', plain: true, className: 'pull-right',
                                onClick: function onClick() {
                                    _this3.setState({
                                        subscriptionItem: !_this3.state.subscriptionItem
                                    });
                                }
                            },
                            '\u6DFB\u52A0\u516C\u4F17\u53F7'
                    ...
                    this.state.relativeData.Gongzhonghaos.map(function (item, index) {
                        return _react2.default.createElement(
                            _packages.MediaBox,
                            null,
                            item.Name,
                            _react2.default.createElement(
                                _packages.Button,
                                { size: 'small', type: 'warn', className: 'pull-right',
                                    onClick: _this3.removeItem.bind(_this3, item.Name, item.GongzhonghaoId, 'subscription') },
                                '\u5220\u9664'
                            )
                        );
                    }),
                    this.state.subscriptionItem ? _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement(_packages.SearchBar, {
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _packages.PanelBody,
                                null,
                                this.state.Gongzhonghaos.map(function (item, index) {
                                    return _react2.default.createElement(
                                        _packages.MediaBox,
                                        { type: 'appmsg',
                                            onClick: _this3.addItem.bind(_this3, item.Name, item.GongzhonghaoId, 'subscription') },
                                        _react2.default.createElement(
                                            _packages.MediaBoxBody,
                                            null,
                                            item.Name
                                        )
                                    );
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _packages.Button,
                        { type: 'default', onClick: this.returnList.bind(this) },
                        '\u8FD4\u56DE\u8BBE\u5907\u5217\u8868'
                    )
                ),
                _react2.default.createElement(_packages.ActionSheet, {
                    show: this.state.mask,
                    type: 'android',
                    onRequestClose: function onRequestClose(e) {
                        return _this3.setState({ mask: false, goodItem: false });
                    }
                }),
                //添加货物弹窗
                this.state.goodItem ? _react2.default.createElement(
                    'div',
                    { id: 'goodItem' },
                    _react2.default.createElement(
                        _packages.CellsTitle,
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _packages.CellBody,
                                null,
                                _react2.default.createElement(_packages.Input, { type: 'number', placeholder: '', max: '20',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _packages.CellBody,
                                null,
                                _react2.default.createElement(_packages.Select, { data: this.state.goods, onChange: this.handleChange.bind(this, 'editGoodItemData', 'Name') })
                            )
                        ),
                        _react2.default.createElement(
                            _packages.FormCell,
                            ...
                            _react2.default.createElement(
                                _packages.Button,
                                { size: 'small', className: 'pull-left', onClick: this.editGoodItem.bind(this) },
                                '\u786E\u5B9A'
                            ),
                            _react2.default.createElement(
                                _packages.Button,
                                { size: 'small', type: 'default', className: 'pull-right',
                                    onClick: function onClick() {
                                        _this3.setState({ mask: false, goodItem: false });
                                    } },
                                '\u53D6\u6D88'
                            )
                        )
...
var MachineAdd = (0, _reactRedux.connect)(mapStateToProps)(MachineAddUi);
exports.default = MachineAdd;

/***/ }),

/***/ "./src/static/css/machine_add.css":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./src/static/css/machine_add.css");
...
if(true) {
	...
	if(!content.locals) {
		module.hot.accept("./node_modules/css-loader/index.js!./src/static/css/machine_add.css", function() {
			var newContent = __webpack_require__("./node_modules/css-loader/index.js!./src/static/css/machine_add.css");
...
var _store = __webpack_require__("./src/store.js");
...
$.ajax({ //获取省市
    ...
    complete: function complete(data) {
        console.log(data);
        var province = JSON.parse(data.responseText).value;
        ...
        $.ajax({ //获取城市
            ...
            type: 'GET',
            complete: function complete(data) {
                var city = JSON.parse(data.responseText).value;
                for (var _i = 0; _i < location.length; _i++) {
                    location[_i].children = [];
                    for (var j = 0; j < city.length; j++) {

                        if (location[_i].value == city[j].ProvinceId) {

                            location[_i].children.push({ label: city[j].Name, value: city[j].CityId });
                        }
                    }
                }
                console.log(location);
...
module.exports = {
    ...
    validForm: function validForm(_this, formData, validMark) {
        // 表单验证函数
        var validData = {}; //临时验证数据结果
        ...
        _this.setState({
            form: (0, _reactAddonsUpdate2.default)(_this.state.form, { $set: validData })
        });
        return validMark;
    },
    XHR: function XHR(obj, url, key, mark) {
        //请求列表数据
        $.ajax({
            url: url,
            type: 'GET',
            complete: function complete(response) {
                if (response.status == 200) {
                    ...
                    switch (mark) {
                        case 'more':
                            //如果是加载更多，追加数据
                            obj.setState(_defineProperty({}, key, obj.state[key].concat(data)));
                            break;
                        default:
                            //默认为更新数据
                            obj.setState(_defineProperty({}, key, data));
                    }
                } else {
                    _weui2.default.alert('数据访问失败');
                }
            }
        });
    }
...
//# sourceMappingURL=1.238e4.chunk.js.map