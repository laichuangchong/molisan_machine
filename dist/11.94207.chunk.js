...
/***/ "./src/advertisement/component.js":
/***/ (function(module, exports, __webpack_require__) {
...
var Advertisement = function (_React$Component) {
    ...
    _createClass(Advertisement, [{
        ...
        value: function componentDidMount() {
            ...
            var url = _common.xhrurl + '/odata/AdvContents?&$skip=' + skip + '&$top=' + _common.inittop;
        ...
        value: function handleSearch(text, e) {
            ...
            if ($.trim(searchText) == '') {
                ...
                url = _common.xhrurl + '/odata/AdvContents?&$skip=' + skip + '&$top=' + _common.inittop;
            } else {
                url = _common.xhrurl + '/odata/AdvContents?$filter=Name eq \'' + searchText + '\'&$skip=' + skip + '&$top=' + _common.inittop;
            }
            (0, _common.XHR)(this, url, 'results');
        }
    }, {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _reactRouter.Link,
                                { to: '/advertisement/add', className: 'pull-right' },
                                _react2.default.createElement(
                                    _packages.Button,
                                    { type: 'primary', size: 'small', plain: true },
                                    '\u6DFB\u52A0\u5E7F\u544A'
                                )
                            )
                        )
                            ...
                            return _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        _reactRouter.Link,
                                        {
                                            to: '/advertisement/edit/' + item.AdvContentId },
                                        item.Name
                                    )
                                )
                            );
...
//# sourceMappingURL=11.94207.chunk.js.map