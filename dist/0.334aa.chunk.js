...
/***/ "./node_modules/css-loader/index.js!./src/static/css/advertisementAdd.css":
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__("./src/static/css/advertisementAdd.css");

var _common = __webpack_require__("./src/static/js/common.js");

var _more = __webpack_require__("./src/coustomComponent/more.js");
...
var AdvertisementAdd = function (_React$Component) {
    _inherits(AdvertisementAdd, _React$Component);

    function AdvertisementAdd(props) {
        _classCallCheck(this, AdvertisementAdd);

        var _this2 = _possibleConstructorReturn(this, (AdvertisementAdd.__proto__ || Object.getPrototypeOf(AdvertisementAdd)).call(this, props));
    ...
    _createClass(AdvertisementAdd, [{
        key: 'returnList',
        value: function returnList() {
            //返回列表按钮
            _reactRouter.hashHistory.push('/home/advertisement');
        }
    }, {
        key: 'handleSearch',
        ...
        value: function moreList() {
            ...
            (0, _common.XHR)(this, url, 'Gongzhonghaos', 'more');
        }
    }, {
        key: 'addItem',
        value: function addItem(name, id, type) {
            ...
            switch (type) {
                ...
                case 'material':
                    ...
                    for (var key in _this.state.material) {
                        if (!_this.state.material.hasOwnProperty(key)) continue; //跳过继承的属性
                        if ($.trim(_this.state.material[key]) && this.state.material.demoFiles.length >= 1) {} else {
                            _weui2.default.alert('请填写完整');
                            return;
                        }
                    }
                    _weui2.default.confirm('确定添加' + name + '吗？', {
        ...
        key: 'handleChange',
        value: function handleChange(type, itemName, e) {
            var _this = this;
            switch (type) {
                case 'subscriptipn':
                    ...
                    break;
                case 'results':
                    _this.setState(_defineProperty({}, type, (0, _reactAddonsUpdate2.default)(_this.state[type], _defineProperty({}, itemName, { $set: e.target.value }))));
                    break;
                case 'videoFile':
                ...
                if ((0, _common.validForm)(_this, formData, validMark)) {
                    ...
                    _weui2.default.confirm('添加成功', {
                        buttons: [{
                            ...
                            type: 'primary',
                            onClick: function onClick() {
                                _reactRouter.hashHistory.push('/advertisement/edit/5');
                                location.reload();
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _packages.CellBody,
                                null,
                                _react2.default.createElement(_packages.Input, { type: 'tel', placeholder: '', value: this.state.results.Name,
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _packages.CellBody,
                                null,
                                _react2.default.createElement(_packages.Input, { type: 'number', placeholder: '', value: this.state.results.Order,
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _packages.CellBody,
                                null,
                                _react2.default.createElement(_packages.Select, { onChange: this.handleChange.bind(this, 'results', 'ContentType'),
                        ...
                        this.state.results.ContentType == 1 ? _react2.default.createElement(
                            _packages.FormCell,
                            null,
                            _react2.default.createElement(
                                _packages.CellHeader,
                            ...
                            _react2.default.createElement(
                                _packages.CellBody,
                                null,
                                _react2.default.createElement(_packages.Input, { type: 'url', placeholder: '', value: this.state.imgUrl })
                            )
                        ) : _react2.default.createElement(
                            _packages.FormCell,
                            null,
                            ...
                            _react2.default.createElement(
                                _packages.CellBody,
                                null,
                                _react2.default.createElement(_packages.Input, { type: 'url', placeholder: '', value: this.state.videoUrl })
                            )
                        ),
                        this.state.results.ContentType == 1 ? _react2.default.createElement(
                            _packages.FormCell,
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'weui-uploader__input-box' },
                                    _react2.default.createElement('input', { type: 'file', ref: 'imgFile', className: 'weui-uploader__input', accept: 'image/*', capture: '',
                            ...
                            _react2.default.createElement(
                                _packages.CellBody,
                                null,
                                _react2.default.createElement('input', { type: 'file', ref: 'videoFile', onChange: this.handleChange.bind(this, 'videoFile') })
                            )
                        ),
                        this.state.results.ContentType == 1 ? _react2.default.createElement(_packages.Progress, { value: this.state.isUploading ? this.state.value : 75, onClick: this.pause.bind(this) }) : _react2.default.createElement(_packages.Progress, { value: this.state.isUploading ? this.state.value : 75, onClick: this.pause.bind(this) })
                    ),
                    _react2.default.createElement(
                        _packages.CellsTitle,
                        null,
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _packages.CellBody,
                                null,
                                _react2.default.createElement(_packages.TextArea, { placeholder: '\u4E0D\u8D85\u8FC750\u5B57', rows: '3', maxlength: '50',
                ...
                this.props.params.id ? _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { type: 'primary', plain: true,
                            onClick: function onClick() {
                                _this3.setState({ addSub: !_this3.state.addSub });
                            } },
                        '\u6DFB\u52A0\u7ED1\u5B9A\u516C\u4F17\u53F7'
                    ),
                    _react2.default.createElement(
                        'div',
                        { style: { display: this.state.addSub ? null : 'none' } },
                        _react2.default.createElement(
                            'div',
                            null,
                            ...
                            _react2.default.createElement(
                                ...
                                this.state.showMore ? _react2.default.createElement(
                                    _packages.PanelFooter,
                                    { onClick: this.moreList.bind(this),
                                        href: 'javascript:void(0);' },
                                    _react2.default.createElement(_more2.default, { text: '\u52A0\u8F7D\u66F4\u591A...', more: true })
                                ) : _react2.default.createElement(
                                    _packages.PanelFooter,
                                    { href: 'javascript:void(0);' },
                                    _react2.default.createElement(_more2.default, { text: '\u65E0\u66F4\u591A...', more: false })
                                )
                            )
                        )
                    )
...
exports.default = AdvertisementAdd;

/***/ }),

/***/ "./src/coustomComponent/more.js":
/***/ (function(module, exports, __webpack_require__) {
...
var CellMore = function (_React$Component) {
    _inherits(CellMore, _React$Component);

    function CellMore(props) {
        _classCallCheck(this, CellMore);

        return _possibleConstructorReturn(this, (CellMore.__proto__ || Object.getPrototypeOf(CellMore)).call(this, props));
    }

    _createClass(CellMore, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                _packages.Cell,
                { access: true, link: true },
                _react2.default.createElement(
                    _packages.CellBody,
                    null,
                    this.props.text
                ),
                this.props.more ? _react2.default.createElement(_packages.CellFooter, null) : ''
            );
        }
    }]);
...
exports.default = CellMore;

/***/ }),

/***/ "./src/static/css/advertisementAdd.css":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./src/static/css/advertisementAdd.css");
...
if(true) {
	...
	if(!content.locals) {
		module.hot.accept("./node_modules/css-loader/index.js!./src/static/css/advertisementAdd.css", function() {
			var newContent = __webpack_require__("./node_modules/css-loader/index.js!./src/static/css/advertisementAdd.css");
...
//# sourceMappingURL=0.334aa.chunk.js.map